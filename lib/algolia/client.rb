...
module Algolia
  ...
  class Client
    ...
    # @param request_options contains extra parameters to send with your query
    #
    def copy_index(src_index, dst_index, request_options = {})
    ...
    #
    def copy_index!(src_index, dst_index, request_options = {})
      res = copy_index(src_index, dst_index, request_options)
      init_index(dst_index).wait_task(res['taskID'], 100, request_options)
      res
    end
    ...
    #   - type Type of logs to retrieve - Default = 'all'
    #   - request_options contains extra parameters to send with your query
    #
  ...
  # @param request_options contains extra parameters to send with your query
  #
  def Algolia.copy_index(src_index, dst_index, request_options = {})
    Algolia.client.copy_index(src_index, dst_index, request_options)
  end
